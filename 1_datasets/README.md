...
selection process, and the complete data dictionary describing all variables,
formats and description of the data.

## Raw Datasets

The following raw datasets have been collected and are stored in the
[`raw_data/`](1_datasets\raw_data) subfolder:
...
#### `SED_Student_log.csv` Data Dictionary
